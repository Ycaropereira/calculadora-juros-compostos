  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-10">
      ...
      <p className="mt-3 text-zinc-700 leading-relaxed">
        Esta calculadora tem finalidade informativa e educacional. Os resultados são
        estimativas e podem não refletir taxas reais de mercado, impostos, tarifas ou
        condições específicas de produtos financeiros.
      </p>
      ...
      <p className="mt-3 text-zinc-700 leading-relaxed">
        ...
        site. Recomendamos consultar profissionais qualificados antes de tomar decisões
        financeiras.
      </p>

      <h2 className="mt-8 text-xl font-semibold text-zinc-900">Alterações</h2>
      <p className="mt-3 text-zinc-700 leading-relaxed">
        Podemos atualizar estes termos a qualquer momento. A versão mais recente estará
